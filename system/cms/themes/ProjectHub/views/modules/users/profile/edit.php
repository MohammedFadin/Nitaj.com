 ...
 -->            <?php echo form_open_multipart('', array('id'=>'user_edit', 'class' => 'crud_form form-horizontal form-border')); ?>																
										...
										<div class="panel-body">
											...
											<div class="form-group">
												...
												<div class="col-md-10">
													<input type="text" name="first_name" class="form-control input-sm" placeholder="First Name" value="<?php echo $_user->first_name; ?>">
												</div><!-- /.col -->
											</div>
											<div class="form-group">
												<label class="control-label col-md-2">Last Name</label>												
												<div class="col-md-10">
													<input type="text" name="last_name" class="form-control input-sm" placeholder="Last Name" value="<?php echo $_user->last_name ?>">
												</div><!-- /.col -->
											</div>											
											<div class="form-group">
